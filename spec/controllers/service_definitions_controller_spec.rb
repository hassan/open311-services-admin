...
RSpec.describe ServiceDefinitionsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # ServiceDefinition. As you add validations to ServiceDefinition, be sure to
  ...
  # ServiceDefinitionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all service_definitions as @service_definitions" do
      service_definition = ServiceDefinition.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested service_definition as @service_definition" do
      service_definition = ServiceDefinition.create! valid_attributes
      get :show, {:id => service_definition.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested service_definition as @service_definition" do
      service_definition = ServiceDefinition.create! valid_attributes
      get :edit, {:id => service_definition.to_param}, valid_session
      expect(assigns(:service_definition)).to eq(service_definition)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created service_definition" do
        post :create, {:service_definition => valid_attributes}, valid_session
        expect(response).to redirect_to(ServiceDefinition.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested service_definition" do
        service_definition = ServiceDefinition.create! valid_attributes
        put :update, {:id => service_definition.to_param, :service_definition => new_attributes}, valid_session
      ...
      it "redirects to the service_definition" do
        service_definition = ServiceDefinition.create! valid_attributes
        put :update, {:id => service_definition.to_param, :service_definition => valid_attributes}, valid_session
        expect(response).to redirect_to(service_definition)
      end
    end
